...
cmd="python3 /MIPT_QuAN/2-PhaseRecognition/train_2.py -test -setsize $set \
...
-wandb_name 'MIPT_${model_num}_L${L}_zerosz_one_g${gamma1}vs${gamma2}_f${fraction}_run_${run}' \
